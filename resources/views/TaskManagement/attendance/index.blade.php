              ...
              <table class="table">
                ...
                <tbody>
                    ...
                    <tr id="delete">
                      ...
                      <td> 
                        <span class="badge
                         @if ($attendance->status=='late')bg-warning 
                         @elseif($attendance->status=='presence') bg-success 
                         @elseif($attendance->status=='absence') bg-danger 
                         @endif ">
                         {{$attendance->statusKey}}
                          </span>
                      </td>
    ...
    function confirmDelete(id){
      ...
      confirmButtonText: 'Yes, delete it!'
        ...
        function performDelete(id){  
          axios.delete('/Task-Management/attendances/'+id)
