...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="Task-Management/index2.html" class="h1"><b>Admin</b>LTE</a>
    </div>
    <div class="card-body">
      ...
      <form >
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="button" onclick="preformLogin()" class="btn btn-primary btn-block">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<script>
   function preformLogin(){
    axios.post('/Task-Management/login',{
